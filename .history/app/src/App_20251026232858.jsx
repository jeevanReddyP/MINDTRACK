...
function AppContent({ isMobile, mobileOpen, setMobileOpen }) {
  ...
  // Routes where Sidebar and BottomNav should be hidden
  const hideLayoutRoutes = ['/', '/login', '/signup', '/challenge'];
    ...
    <MUIThemeProvider theme={theme}>
      ...
      <Box sx={{ display: 'flex', minHeight: '100vh' }}>
        ...
        <Box
          ...
          sx={{
            flexGrow: 1,
            p: shouldHideLayout ? 0 : 3,
            pb: shouldHideLayout ? 0 : 8,
            width: { xs: '100%', sm: 'auto' },
            marginLeft: !shouldHideLayout ? { sm: '240px' } : 0,
          }}
        >
          <Routes>
            {/* Public / Auth routes */}
        ...
        {/* Bottom navigation only visible when layout is shown */}
