  ...
  return (
    <div className="flex min-h-screen bg-gray-50 text-gray-800">
      ...
      <div className="flex flex-col flex-1">
        {/* Top Navigation Bar */}
        <header className="fixed w-full md:ml-64 bg-white/90 backdrop-blur-sm shadow-sm z-20 border-b border-gray-200">
              ...
              <div className="md:col-span-5 space-y-8">
                ...
                <div className="bg-gradient-to-r from-teal-500 to-blue-500 text-white rounded-3xl p-6 shadow-lg">
                  ...
                  <p className="text-white/90">
                    Keep going strong — every small habit adds up to big
                    change.
                  </p>
                </div>
