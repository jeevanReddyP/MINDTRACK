...
// Mock data
const stats = [
  { title: 'Habits Tracked', value: '5/8', icon: <SparklesIcon className="h-6 w-6" />, color: 'bg-blue-500'},
  { title: 'Water Intake', value: '6/8 cups', icon: <DropletIcon className="h-6 w-6" />, color: 'bg-teal-400'},
  { title: 'Meditation', value: '10 min', icon: <HandRaisedIcon className="h-6 w-6" />, color: 'bg-green-500'},
];
