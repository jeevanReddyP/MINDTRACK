    ...
    <Box sx={{ p: 3 }}>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={8}>
          <Paper sx={{ p: 2, mb: 3 }}>
            <Tabs value={tabValue} onChange={handleTabChange} aria-label="exercise tabs" sx={{ mb: 2 }}>
              <Tab label="Today" />
              <Tab label="This Week" />
              <Tab label="History" />
            </Tabs>
                ...
                <React.Fragment key={exercise.id}>
                  <ListItem>
                    <ListItemText
                      ...
                      secondary={`${exercise.duration} min • ${exercise.calories} cal • ${exercise.date}`}
                    />
                    <ListItemSecondaryAction>
